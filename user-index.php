        ...
        <table class="table table-bordered"  id="example2">
          ...
          <tbody>
            <?php
              ...
              $datas = mysqli_query($koneksi, "select login.*, data_pegawai.Nama as nama from login JOIN data_pegawai ON data_pegawai.id = login.pegawai_id group by login.pegawai_id") or die(mysqli_error($koneksi));
