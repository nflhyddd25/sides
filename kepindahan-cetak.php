...
<body class="A4">
  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;overflow: auto; ">
    ...
    <h4 class="text-center">SURAT KETERANGAN PINDAH DOMISILI</h4>
    <hr>
        <?php
          include('koneksi.php');
          ...
          <table class="" style="font-size:12px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
             ...
             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah benar-benar penduduk Desa Utara Kecamatan Bumi, Kabupaten Tanah yang akan pindah Domisili ke tempat :</td>
            </tr>

            <tr>
              <td style="text-align:left;width: 160px;">Alamat Pindah</td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['Alamat_Pindah'] ?></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Tanggal </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"> <?= format_tanggal($row['Tanggal_Pindah']); ?></td>
            </tr>
             <tr>
