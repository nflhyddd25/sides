  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;overflow: auto; ">
    ...
    <h3 class="text-left">Jl. Abc RT 04 RW 02 Kode Pos 70000</h3><div style="width: 100%;height: 2px;background-color: #3d3d3d;-webkit-print-color-adjust: exact;"></div>
     <?php
          ...
          ?>
    <h4 class="text-center">SURAT KETERANGAN KELAHIRAN</h4>
    <hr>
          ...
          <table class="" style="font-size:12px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td style="text-align:left;width: 160px;">No KK</td>
            ...
            <tr>
              ...
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['NIKS'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['J_Kelamin'] ?></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Waktu Lahir </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['Hari_Lahir'] ?>, <?= format_tanggal($row['tgl_Lahir']); ?></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Tempat </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['Tempat_Lahir'] ?> <?= $row['Pukul'] ?> WITA</td>
            </tr>
            <tr>
             ...
             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan kelahiran ini dibuat sebagai surat pengantar untuk pembuatan Akte Kelahiran.</td>
            </tr>
          </table>
