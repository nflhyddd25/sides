      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label>Foto KK (abaikan jika tidak ganti foto) - <a target="_blank" href="assets/gambar/<?= $row['Foto_KK']; ?>">Foto sebelumnya</a></label>
...
<?php
      ...
      $datas = mysqli_query($koneksi, "update data_pelapor set status_data ='$status_data',No_Surat ='$No_Surat',keterangan ='$keterangan',tgl_lapor = '$tgl_lapor', Foto_Surat_Pengantar = '$Foto_Surat_Pengantar', Foto_KTP = '$Foto_KTP', Foto_KK = '$Foto_KK' where id = '$id'") or die(mysqli_error($koneksi));
