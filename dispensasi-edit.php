...
<?php
          ...
          $id = $_GET['id']; 
          $data   = mysqli_query($koneksi, "select * from data_dispensasi where id = '$id'");
...
<?php
      ...
      $datas = mysqli_query($koneksi, "update data_dispensasi set status_data ='$status_data',nik_suami ='$nik_suami',nama_suami ='$nama_suami',pekerjaan_suami ='$pekerjaan_suami', nik_istri ='$nik_istri',nama_istri ='$nama_istri',pekerjaan_istri ='$pekerjaan_istri',tanggal ='$tanggal',keterangan = '$keterangan' where id = '$id'") or die(mysqli_error($koneksi));
      echo "<script>alert('data berhasil diubah.');window.location='dispensasi-index.php';</script>";
  }
  ?>
  <?php
