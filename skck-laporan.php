  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;overflow: auto; ">
    ...
    <h3 class="text-left">Jl. Abc RT 04 RW 02 Kode Pos 70000</h3><div style="width: 100%;height: 2px;background-color: #3d3d3d;-webkit-print-color-adjust: exact;"></div>
     <?php
          ...
          ?>
    <h4 class="text-center">SURAT PENGANTAR SKCK</h4>
    <hr>
          ...
          <table class="" style="font-size:12px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['pekerjaan'] ?></td>
            </tr>
            ...
            <tr>
             ...
             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah benar-benar penduduk Desa Utara Kecamatan Bumi, Kabupaten Tanah. Serta kami menerangkan bahwa orang tersebut berkelakuan baik dan belum pernah tersangkut perkara Polisi. Surat Keterangan ini untuk memenuhi salah satu persyaratan Surat Keterangan Catatan Kepolisian (SKCK).</td>
            </tr>
             <tr>
