...
<body class="A4">
  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;overflow: auto; ">
    ...
    <h4 class="text-center">SURAT KETERANGAN TIDAK MAMPU</h4>
    <hr>
        <?php
          include('koneksi.php');
          ...
          <table class="" style="font-size:12px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['Tempat_Lahir'] ?>, <?= format_tanggal($row['Tanggal_Lahir']); ?></td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah benar-benar penduduk Desa Utara Kecamatan Bumi, Kabupaten Tanah dan termasuk salah satu KELUARGA MISKIN/TIDAK MAMPU.</td>
            </tr>
             <tr>
