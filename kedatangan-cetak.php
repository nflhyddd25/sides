...
<body class="A4">
  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;overflow: auto; ">
    ...
    <h4 class="text-center">SURAT KETERANGAN KEDATANGAN</h4>
    <hr>
        <?php
          include('koneksi.php');
          ...
          <table class="" style="font-size:12px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
             ...
             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah penduduk dari luar domisi yang pindah ke Desa Utara, Kecamatan Bumi, Kabupaten Tanah dengan data asal sebagai berikut :</td>
            </tr>

            <tr>
              <td style="text-align:left;width: 160px;">Alamat Asal</td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['Alamat_Asal'] ?></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Tanggal Kedatangan </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"> <?= format_tanggal($row['Tanggal_Kedatangan']); ?></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Alamat Sekarang</td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['Alamat_Sekarang'] ?></td>
            </tr>
             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan ini dibuat untuk sebagai salah satu persyaratan kepindahan domisili.</td>
            </tr>
          </table>
