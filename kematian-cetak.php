    ...
    <hr>
          ...
          <table class="" style="font-size:12px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
             ...
             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data diatas telah meninggal pada waktu :</td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Waktu Meninggal </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['Hari_Meninggal'] ?>, <?= format_tanggal($row['Tgl_Meninggal']); ?></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Tempat </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['Tempat'] ?></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Umur </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['Umur'] ?> Tahun</td>
            </tr>

             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan kematian ini dibuat untuk digunakan sebagai mana mestinya.</td>
            </tr>
          </table>
