  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;overflow: auto; ">
    ...
    <h3 class="text-left">Jl. Abc RT 04 RW 02 Kode Pos 70000</h3><div style="width: 100%;height: 2px;background-color: #3d3d3d;-webkit-print-color-adjust: exact;"></div>
     <?php
          ...
          ?>
    <h4 class="text-center">SURAT KETERANGAN <?= ($row['status'] == 'org_sama' ? 'ORANG YANG SAMA' : 'ORANG YANG BERBEDA'); ?></h4>
    <hr>
          ...
          <table class="" style="font-size:12px;" cellpadding="0" cellspacing="0">
            ...
            <tr>
             ...
             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Orang yang dimaksud : </td>
            </tr>

            <tr>
              <td style="text-align:left;width: 160px;">NIK</td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['nik_orang'] ?></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Nama </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['nama_orang'] ?></td>
            </tr>
             <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah benar-benar orang <?= ($row['status'] == 'org_sama' ? 'yang sama atau bukan orang lain' : 'yang berbeda'); ?> dari yang tercatat di data kependudukan.</td>
            </tr>
             <tr>
